		...
		<div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 font-sans dark:bg-black">
			<main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
				...
				<div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
					...
					<p className="text-lg leading-8 text-zinc-300 text-balance">HopDuck is a fast, no-nonsense URL shortener currently under construction. Short links, zero fluff — launching soon.</p>
				</div>
			...
			<footer className="h-18 w-full max-w-full flex items-center justify-center">
				<div className="container self-stretch px-4 sm:px-6 lg:px-8 flex items-center justify-center">
					<div className="max-w-3xl w-full px-16">
						<p className="text-sm text-zinc-500 relaxed">&copy; {new Date().getFullYear()} HopDuck</p>
					</div>
				</div>
			</footer>
		</div>
